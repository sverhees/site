...
* [Mainz Grammaticalization Project (MAGRAM)](https://en.magram.fb05.uni-mainz.de) -- база путей грамматикализации
* [Glottobank](https://glottobank.org) -- семья новых баз данных, включая Grambank (= WALS 2.0)

...
I also manage an [Instagram](https://www.instagram.com/botlikh_rasha/) account about the Botlikh language, and [here](https://sverhees.github.io/botlikh_khabar/) you can read some texts from the corpus in Botlikh and Russian.
...
The [Daghestanian Loans](https://ilcl.hse.ru/en/projects) project investigates how patterns of multilingualism in Dagestan are reflected in lexical borrowings at the village level. I worked on this project with Michael Daniel, Ilya Chechuro and Nina Dobrushina from 2017--2019, collecting and annotating lexical data. The results are a [database](https://lingconlab.github.io/Dagloan_database/DL_database.html), several talks and posters, and two papers which are <span style="color: #CC0066;">submitted / to appear</span>.
